...
def setup():
    global bird_y, bird_velocity, pipe_x, pipe_height, score, game_over, enemy_x, enemy_y, shoot_timer, projectiles, health, last_frame_time, fps
    bird_y = HEIGHT // 2
    bird_velocity = 0
    pipe_x = WIDTH
    pipe_height = random.randint(150, 400)
...
def draw_bird():
    # Draw bird: oval body, triangular wing, small eye
...
async def main():
    ...
    while True:
        update_loop()
        await asyncio.sleep(1.0 / 65)  # 60 FPS
